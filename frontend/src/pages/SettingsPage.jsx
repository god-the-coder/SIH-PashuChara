...
export default function SettingsPage() {
  ...
  const handleSwitchToDemoUser = (name, phone, cattle) => {
    login({
      name,
      isCustomName: true,
      phone,
    ...
    showToast(`उपयोगकर्ता बदलकर "${name}" किया गया! ✓`);
  };
    ...
    <div className="relative min-h-screen w-full overflow-x-hidden text-[#1a1c18] dark:text-[#f3ede2] flex justify-center bg-[#FAF7F0] dark:bg-[#0c130e] antialiased">
      <div className="relative z-10 w-full max-w-[430px] min-h-screen flex flex-col justify-between shadow-2xl bg-[#FAF7F0] dark:bg-[#111713]">
        ...
        <SubPageHeader
          ...
          subtitle="फॉन्ट, डेटा, थीम व उपयोगकर्ता प्रबंधन"
          backTo="/dashboard"
        />
        ...
        <main className="p-4 space-y-4 flex-1 overflow-y-auto">
          ...
          <div className="bg-white dark:bg-[#181e18] p-4 rounded-3xl border border-[#ded5c2] dark:border-[#28382d] shadow-sm space-y-3.5">
            <h3 className="text-xs font-black uppercase text-[#14351d] dark:text-[#a8cfb4] tracking-wider">
              🖥️ डिस्प्ले व थीम (Appearance)
            </h3>

            {/* Dark / Light Mode Toggle */}
            <div className="flex items-center justify-between py-1">
              <div>
                <span className="text-xs font-bold text-[#14351d] dark:text-white block">
                  डार्क / लाइट मोड (Screen Theme)
                </span>
            ...
            <div className="pt-2 border-t border-gray-100 dark:border-white/5">
              <span className="text-xs font-bold text-[#14351d] dark:text-white block mb-2">
                फॉन्ट आकार (Text Font Size)
              </span>
              <div className="grid grid-cols-3 gap-2">
                {[
                  { id: "small", label: "छोटा (A-)", sub: "Compact" },
                  { id: "normal", label: "सामान्य (A)", sub: "Default" },
                  { id: "large", label: "बड़ा (A+)", sub: "Large" },
                ].map((f) => (
                  <button
                    key={f.id}
                    onClick={() => {
                    ...
                    className={`py-2 px-1 rounded-2xl border text-center transition-all cursor-pointer ${
                      fontSize === f.id
                        ...
                        : "bg-[#faf7f0] dark:bg-[#121914] text-gray-700 dark:text-gray-300 border-[#ded5c2] dark:border-[#28382d]"
                    }`}
                  >
          ...
          <div className="bg-white dark:bg-[#181e18] p-4 rounded-3xl border border-[#ded5c2] dark:border-[#28382d] shadow-sm space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="text-xs font-black uppercase text-[#14351d] dark:text-[#a8cfb4] tracking-wider">
                👥 उपयोगकर्ता प्रबंधन (User Accounts)
              </h3>
              <button
            ...
            <div className="space-y-2">
              <div className="p-3 rounded-2xl bg-[#faf7f0] dark:bg-[#121914] border border-[#2D5A3D] flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <span className="text-xs font-black text-[#14351d] dark:text-white block">
                      {user?.name || "रमेश चौधरी"} (सक्रिय खाता)
                    </span>
                    <span className="text-[10px] text-gray-500 dark:text-gray-400">
                      +91 {user?.phone || "9876543210"} • {user?.cattleCount || 24} पशु
                    </span>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-2xl bg-white dark:bg-[#141914] border border-[#ded5c2] dark:border-[#28382d]">
                <div>
                  <span className="text-xs font-bold text-[#14351d] dark:text-white block">
                    सुरेश पटेल (Suresh Patel)
                  </span>
                  <span className="text-[10px] text-gray-500 dark:text-gray-400">
                    +91 9428011223 • 18 पशु
                  </span>
                </div>
                <button
                  onClick={() => handleSwitchToDemoUser("सुरेश पटेल", "9428011223", 18)}
                  className="px-3 py-1 rounded-xl bg-gray-100 dark:bg-white/10 hover:bg-emerald-50 text-xs font-bold text-[#14351d] dark:text-gray-200 cursor-pointer"
                >
                  स्विच करें
                </button>
              </div>
          ...
          <div className="bg-white dark:bg-[#181e18] p-4 rounded-3xl border border-[#ded5c2] dark:border-[#28382d] shadow-sm space-y-3">
            <h3 className="text-xs font-black uppercase text-[#14351d] dark:text-[#a8cfb4] tracking-wider">
              💾 स्टोरेज व डेटा प्रबंधन (Storage & Data)
            </h3>
            ...
            <div className="flex items-center justify-between py-1">
              <div>
                <span className="text-xs font-bold text-[#14351d] dark:text-white block">
                  कैश साफ करें (Clear App Cache)
                </span>
                <span className="text-[10px] text-gray-500 dark:text-gray-400">
                  अस्थायी तस्वीरें व स्कैन डेटा हटाएं (~12 MB)
                </span>
              </div>
              <button
                onClick={clearCache}
                className="px-3.5 py-1.5 rounded-xl border border-[#ded5c2] dark:border-[#28382d] hover:bg-gray-100 dark:hover:bg-white/5 text-xs font-bold text-gray-700 dark:text-gray-200 cursor-pointer"
              >
                साफ करें 🧹
              </button>
            </div>
            ...
            <div className="pt-2 border-t border-gray-100 dark:border-white/5 flex items-center justify-between">
              <div>
                <span className="text-xs font-bold text-red-600 dark:text-red-400 block">
                  खाता व समस्त डेटा हटाएं (Delete Account)
                </span>
                <span className="text-[10px] text-gray-500 dark:text-gray-400">
                  सभी रिकॉर्ड्स स्थायी रूप से हटा दिए जाएंगे
                </span>
              </div>
              <button
        ...
        {deleteConfirmOpen && (
          <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-[#FAF7F0] dark:bg-[#16201a] w-full max-w-xs rounded-3xl p-5 border border-[#ded5c2] dark:border-[#28382d] shadow-2xl text-center">
              <span className="text-3xl">⚠️</span>
              <h3 className="text-sm font-black text-[#14351d] dark:text-white mt-2">
                क्या आप डेटा हटाना चाहते हैं?
              </h3>
              <p className="text-xs text-gray-600 dark:text-gray-300 mt-1 leading-snug">
                आपका प्रोफ़ाइल, चारा इतिहास और सभी पशु विवरण हमेशा के लिए हटा दिए जाएंगे।
              </p>
            ...
            <div className="bg-[#FAF7F0] dark:bg-[#16201a] w-full max-w-sm rounded-3xl p-5 border border-[#ded5c2] dark:border-[#28382d] shadow-2xl">
              <div className="flex items-center justify-between pb-3 border-b border-[#ded5c2] dark:border-[#28382d]">
                <h3 className="text-sm font-black text-[#14351d] dark:text-white">
                  नया उपयोगकर्ता प्रोफाइल जोड़ें
                </h3>
                <button
