  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-[390px] rounded-3xl bg-[#FAF7F0] dark:bg-[#181a17] text-[#1a1c18] dark:text-[#e8e4dc] border border-[#e5dfd3] dark:border-[#2b332b] shadow-2xl overflow-hidden p-6 transition-all"
      >
        {/* Close Button */}
        <button
          onClick={closeAuthModal}
          ...
          <div className="space-y-4">
            <div className="text-center pt-2 pb-1">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                {t.authModalSub || "अपनी चारा गुणवत्ता रिपोर्ट व पशुधन डेटा सुरक्षित रखने हेतु लॉगिन करें"}
              </p>
            </div>
            ...
            <form onSubmit={handleSendOtp} className="space-y-3 pt-1">
              ...
              >
                <span>{isLoading ? (t.listeningText || "कृपया प्रतीक्षा करें...") : (t.getOtpBtn || "OTP प्राप्त करें")}</span>
          ...
          <form onSubmit={handleCompleteSurvey} className="space-y-3 pt-1">
            ...
            <div>
              <label className="block text-[11px] font-bold text-gray-700 dark:text-gray-300 mb-1">
                {t.fullNameLabel || "1. पूरा नाम (Farmer Name) *"}
              </label>
              <input
                type="text"
                required
                placeholder={t.navFarmerName || "जैसे: रमेश चौधरी"}
