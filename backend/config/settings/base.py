...
# NOTE: local disk storage — fine for dev, but ephemeral on Render's free/starter
# web services (wiped on every redeploy/restart). Swap for S3-compatible object
# storage (django-storages) before this serves real farmers in production.
MEDIA_URL = 'media/'
