...
[![SIH 2026](https://img.shields.io/badge/SIH%202026-Problem%20ID%20SIH26111-brightgreen.svg)](https://sih.gov.in)
[![Theme](https://img.shields.io/badge/Theme-Agriculture%2C%20FoodTech%20%26%20Rural%20Development-orange.svg)](#)
[![Team](https://img.shields.io/badge/Team-Code4Cause%20(7687)-blue.svg)](#)
...
```mermaid
flowchart TD
    Start([Farmer Opens PashuChara]) --> Lang[Select Language: Hindi, English, Marathi, Gujarati, Kannada, Tamil]
    Lang --> ConnCheck{Internet Available?}

    %% ONLINE PATH
    ConnCheck -->|Yes - Online| CameraHUD[Live Viewfinder with Real-Time HUD]
    CameraHUD --> HUDCheck{Camera Clear & Focused?}
    ...
    Report --> FinalResult[Display Rating: 🟢 Safe / 🟡 Caution / 🔴 Danger]
    ...
    SaveLocal -.->|Internet Restores Later| AutoSync[Automatic Background Sync]
    AutoSync -.-> Upload

    %% ACTIONS
    FinalResult --> Share[Share via WhatsApp / Print PDF]
    FinalResult --> Rations[Adjust Daily Feed Rations for Herd]
```
...
| **Cloud Hosting** | ![Render](https://img.shields.io/badge/Render-000000?style=flat&logo=render&logoColor=white) | High-availability cloud deployment |
...
<p align="center">
  <b>PashuChara (पशुचारा) - Empowering Dairy Farmers, Protecting Livestock, Enriching Lives.</b><br/>
